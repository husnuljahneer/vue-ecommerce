...
<section v-if="cartTotalPrice > 0">
  <div class="flex flex-row justify-center h-full sm:h-screen md:h-screen lg:h-screen overflow-hidden">
    <div
      class="
        lg:w-1/2
        md:w-full
      ...
      "
    >
      <div class="flex flex-col sm:flex-row md:flex-row lg:flex-row p-10 justify-between">
        <div class="mb-5">
        ...
        <div>
          <h1 class="text-right text-base text-black">
            Total Price :
            <span class="font-bold text-yellow-800">{{ cartTotalPrice+shippingRate }}.00 $</span>
          </h1>
    ...
    <div class="w-0 lg:w-1/2 md:w-0 sm:w-0 xs:w-0 image_checkout_div">&nbsp;</div>
  </div>
  </section>
...
export default {
  ...
  created() {
    ...
    // alert(this.userEmail + this.userId);
    this.startTimer();
  },
};
</script>
